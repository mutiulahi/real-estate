...
<table class="table table-striped">
  ...
  <?php
		...
		$query = "SELECT property_name, property_location, property_price, property_access, property_description FROM property WHERE username= '$username'";
