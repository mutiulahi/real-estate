...
?>
                            ...
                            <div class="input-group-icon mt-10">
								<div  id="default-select">
											<select name ="seller_type" class="form-controls">
							...
							<div class="mt-10">
                              ...
                              <div class="mt-10">
								<textarea class="form-controlText" name="seller_address" placeholder="Seller/Agent Office Address" onfocus="this.placeholder = ''"
     ...
     <option value="Outside Nigeria">Outside Nigeria</option>
                            ...
                            <div class="mt-10">
                              ...
                              <div class="mt-10">
								<textarea class="form-controlText" name="property_description" placeholder="Give description of property" onfocus="this.placeholder = ''"
...
<button type="submit" name="submit" class="btn btn-design">Apply for Property Sale Placement</button>
</div>
