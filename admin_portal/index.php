...
<?php  
    ...
    if(empty($db_username) && empty($db_password)){
     ...
     elseif (!empty($db_username) && !empty($db_password)){
		...
		$_SESSION["username_admin"]= $db_username[0];
...
?>
							...
							<div class="mt-10">
								<input type="text" name="username" placeholder="Enter Admin username"
									onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Admin  username'" required
									class="form-controls">
							</div>
                            
                            <div class="mt-10"> 
								<input type="password" name="password" placeholder="Enter Admin password"
									onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Admin password'" required
									class="form-controls">
							</div>
...
<button type="submit" class="btn btn-design" name="login">Login</button>
</div>
